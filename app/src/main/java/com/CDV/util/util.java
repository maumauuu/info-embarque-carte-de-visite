...
import static com.CDV.MainActivity.*;
...
public class util {
    ...
    public static void Fill(String c){
    ...
    public static void Ajouter_contact(ArrayList<ContentProviderOperation> ops, int rawContactInsertIndex, Activity act,
